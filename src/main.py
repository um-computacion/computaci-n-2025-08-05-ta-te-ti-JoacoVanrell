...
def main():
    print("Bienvenidos al Tateti de JoacoVanrell!")
    juego = Tateti()
    nombre1 = input('Ingrese el nombre del jugador de la ficha X: ').strip() or "Jugador X"
    nombre2 = input('Ingrese el nombre del jugador de la ficha 0: ').strip() or "Jugador 0"
