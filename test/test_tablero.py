...
class TestTablero(unittest.TestCase):
    ...
    def test_no_ganar_con_dos_en_linea(self):
        ...
        try:
            ...
            self.fail("Se lanzó Ganador con solo dos en línea")
    ...
    def test_empate_true_sin_ganador(self):
        ...
        try:
            ...
            self.fail("No debería haber ganador en este tablero")
        with self.assertRaises(Empate):
            self.t.chequear_empate()

    def test_empate_no_lanza_si_falta_una(self):
        self.t.contenedor = [
            ["X", "0", "X"],
            ["X", "0", "0"],
            ["0", "X", ""], 
        ...
        try:
            ...
            self.fail("Se lanzó Empate con tablero incompleto")

    def test_ultima_jugada_ganadora_no_es_empate(self):
        ...
        try:
            ...
            self.fail("No debe haber empate si hay ganador")
